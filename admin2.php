        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <center><img src="img/dlh3.webp" width="500" class="img img-responsive" height="500"></center><br>
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat datang admin Dinas Lingkungan Hidup</strong>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2022 EUIS GUNIA <a href="#">EUIS GUNIA</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
