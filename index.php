        ...
        <div class="row">
          <div class="col-lg-7">
            <div class="hero-banner__img">
              <img class="img-fluid" src="img/dlh2.png" alt="" width="1200px">
            </div>
          </div>
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              <h1>Selamat Datang Di Website Dinas Lingkungan Hidup</h1>
              <p>Website ini berfungsi sebagai absensi karyawan dan sebagai sistem informasi kehadiran karyawan </p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">EUIS GUNIA</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">0895-3343-98827</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script>EUIS GUNIA<i class="fa fa-heart" aria-hidden="true"></i> by <a href="#" target="_blank">EUIS GUNIA</a>
      </p>
				<div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
					<a href="#" target="_blank"><i class="fab fa-facebook-f"></i></a>
					<a href="#" target="_blank"><i class="fab fa-whatsapp"></i></a>
					<a href="https://www.instagram.com/ariapratamaaaa/" target="_blank" ><i class="fab fa-instagram" target="_blank"></i></a>
